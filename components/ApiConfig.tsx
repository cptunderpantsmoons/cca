...
const ApiConfig: React.FC<ApiConfigProps> = ({ provider, apiKey, model, voiceModel, onProviderChange, onApiKeyChange, onModelChange, onVoiceModelChange }) => {
  ...
  return (
    <div className="bg-gray-800/50 p-6 rounded-xl border border-gray-700 mb-8 max-w-4xl mx-auto">
      <h2 className="text-xl font-bold text-white mb-4">API Configuration</h2>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {/* Provider Selection */}
        <div>
          <label className="block mb-2 text-sm font-medium text-gray-300">API Provider</label>
          <div className="flex gap-4">
            ...
            <label className="flex items-center space-x-2 cursor-pointer">
              ...
              />
              <span className="text-gray-200">OpenRouter</span>
            </label>
          </div>
        </div>
        ...
        {/* Model Selection */}
        <div>
          <label htmlFor="model-select" className="block mb-2 text-sm font-medium text-gray-300">Model</label>
          {provider === 'gemini' ? (
             <select 
                id="model-select" 
                value={model}
      ...
      {/* API Key Input */}
      <div className="mt-6">
        <label htmlFor="api-key-input" className="block mb-2 text-sm font-medium text-gray-300">
        ...
        <div className="relative">
          <input 
            ...
            className="bg-gray-700 border border-gray-600 text-white text-sm rounded-lg focus:ring-sky-500 focus:border-sky-500 block w-full p-2.5 pr-10"
          />
          <button 
            type="button" 
       ...
       {provider === 'openrouter' && (
         <div className="mt-6">
            <label htmlFor="voice-model-input" className="block mb-2 text-sm font-medium text-gray-300">
